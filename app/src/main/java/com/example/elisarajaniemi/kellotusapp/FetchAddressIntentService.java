...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            System.out.println("Latitude AAAA:  " + location.getLatitude());
            System.out.println("Longitude AAAA: " + location.getLongitude());
        ...
        if (addresses == null || addresses.size()  == 0) {
            ...
            System.out.println("OSOITE LÖYTYI!: " + addressFragments);
